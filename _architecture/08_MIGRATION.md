...
The previous workflow, capability, component, task-runtime, planner-catalog, context,
reasoning-program, scaffold, and specialist-agent systems were intentionally deleted.
There is no compatibility layer and no dual-write period.
