...
from lasi.contracts import ExperimentPlan, ToolSpec
from lasi.contracts.models import PlannedToolRun
    ...
    def compile(
        ...
        *,
        ...
        plan = ExperimentPlan(
            ...
            privacy_mode=recommendation.get("privacy_mode", "local_only"),
            approval_required=bool(recommendation.get("approval_required", backend == "remote")),
